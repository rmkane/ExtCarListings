/**
* File: app/config/AppConfig.js
*/
Ext.define("CarListingApp.config.AppConfig", {
  statics: {
  ...
  config: {
    ...
    MOCK_DATA_ENV: {
      endpoints: {
        listScenarios: {
          proxyId: "deftjs-carApp-scenarios-test"
        },
        listScenarioItems: {
          proxyId: "deftjs-carApp-scenarioItems-test"
        }
      },
      defaults: {
        urlPrefix: "data/",
    ...
    PRODUCTION_ENV: {
      endpoints: {
        listScenarios: {
          proxyId: "deftjs-carApp-scenarios"
        },
        listScenarioItems: {
          proxyId: "deftjs-carApp-scenarioItems"
        }
      },
      defaults: {
        urlPrefix: "/",
  ...
  */
  ...
  constructor: function(cfg) {
    if ((cfg != null ? cfg.environment : void 0) && (CarListingApp.config.AppConfig[cfg.environment] != null)) {
      return this.setEnvironment(CarListingApp.config.AppConfig[cfg.environment]);
    } else {
      return this.setEnvironment(CarListingApp.config.AppConfig.PRODUCTION_ENV);
    }
  },
  /**
